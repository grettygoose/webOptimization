...
// The general method/rule for optimizing your for-loops is this: if a value
// doesn't change during the loop, compute that value outside of the loop,
// store it in a variable, and then call it by the variable name inside the loop.
...
function updatePositions() {
  ...
  // Holds the 5 values that kept repeating in the long for-loop by keeping
  // them in the constArray
